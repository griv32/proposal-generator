...
class ProjectRequirements(BaseModel):
    ...
    technical_needs: List[str] = Field(default_factory=list, description="Technical requirements")
    key_deliverables: List[str] = Field(default_factory=list, description="Main project deliverables")
...
class ProposalData(BaseModel):
    ...
    implementation_phases: List[ImplementationPhase] = Field(..., description="Project phases")
