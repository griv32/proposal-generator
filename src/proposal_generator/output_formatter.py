...
class OutputFormatter:
    ...
    def format_markdown(self, proposal_data: ProposalData, company_name: str = None) -> str:
    ...
    def save_outputs(self, proposal_data: ProposalData, output_folder: str = "./outputs", filename: str = None) -> Dict[str, str]:
